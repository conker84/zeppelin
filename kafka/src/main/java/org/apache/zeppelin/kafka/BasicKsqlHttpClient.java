...
public class BasicKsqlHttpClient implements Closeable {
    ...
    public String connect() throws IOException {
        ...
        return IOUtils.toString(isStatusOk ? connection.getInputStream() : connection.getErrorStream(), UTF_8);
    }
    ...
    public static void main(String... args) throws IOException {
        BasicKsqlHttpClient client = new Builder()
                .withJson("{\"ksql\": \"SELECT * FROM ORDERS;\", \"streamsProperties\": {}}")
                .withUrl("http://localhost:8088/query")
                .withHeader("Content-Type", "application/vnd.ksql.v1+json; charset=utf-8")
                .withTimeout(3000)
                .withType("POST")
                .build();
        client.connectAsync(new BasicHTTPClientResponse() {
            @Override
